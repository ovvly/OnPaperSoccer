...
extension UIColor {
    struct App {
        ...
        static let green = UIColor(red: 70/255, green: 240/255, blue: 110/255)
        static let red = UIColor(red: 255/255, green: 64/255, blue: 78/255)
        static let blue = UIColor(red: 0/255, green: 191/255, blue: 243/255)
